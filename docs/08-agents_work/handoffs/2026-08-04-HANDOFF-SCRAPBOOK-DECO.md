...
### ⚠️ The blocker you will hit immediately
**`Bash(curl *)` is in the `deny` list of the committed `.claude/settings.json`**, and the auto-mode classifier independently blocks network egress by any other route (python3 included). Generated assets therefore **cannot reach disk without founder action**.

Do **not** route around this — a policy you evade is not a policy. The fix is one of:
- Remove `Bash(curl *)` from deny, and allow only `Bash(curl -sL https://d8j0ntlcm91z4.cloudfront.net/*)` in `settings.local.json` (**recommended** — the egress control survives for everything else), or
- The founder pastes the download command each round with the `!` prefix (works today; costs one paste per batch).

### Generated but NOT yet downloaded
Prefix: `https://d8j0ntlcm91z4.cloudfront.net/user_3GsJ2DSZxGcIbdUGLeK8PnRpye2/hf_20260804_101902_`

| Asset | Job ID |
|---|---|
| pressed rose | `1513dafc-0af6-455c-93da-e7107f40a937` |
| pressed lavender | `b66c64a8-bd04-4d1c-ab9a-9aa10d121441` |
| baby's breath | `5301c7a6-20a3-4948-940a-d3c401b8d8e0` |
| pressed daisy | `e3782605-5eb6-4b69-8d4c-acdafed23951` |
| disco ball | `192cb648-d4f7-4f5f-843c-499446f29bc7` |
| gold foil star | `0db0a82e-5993-4ce3-9820-898112646e20` |
| cinema ticket stub | `8ced68e5-2319-48a5-8b42-4de030fec608` |
| vinyl 45 | `eb024125-0280-4934-a425-12afa5d87636` |
| postage stamp | `25642962-4286-4f50-912d-d5c67bf0dfa9` |
| pressed butterfly | `f6cccec3-c3f4-4319-bb09-d016dd2769f4` |
| queen of hearts | `c237d2c2-532b-4fc0-b70d-9efb6f2ef62e` |

Also outstanding: **the ribbon bow was rate-limited (429) and never submitted** — regenerate it.
...
- **Never route around a denied permission.** One agent fetched a font through Playwright after `curl` was denied. It was corrected and acknowledged. When you hit a wall: stop, report, escalate.
