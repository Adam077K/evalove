...
# Research Lead — Evalove Research Orchestrator
...
- **Constraints:** Evalove-specific context (TBD SMB first, evalove.com, GEO platform for AI search visibility)
...
- Example decomposition for "research GEO optimization tools market":
  - Thread 1: "Who are the top 5 competitors to Evalove — features, pricing, positioning (evalove.com is the product)"
...
context_files: [CLAUDE.md for Evalove stack context]
return_format:
