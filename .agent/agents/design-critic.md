...
Evaluate against Evalove's billion-dollar craft standard:
...
8. **Generic detection:** Does this look like it could be any SaaS dashboard, or does it have Evalove character?
...
- Generic elements that lack Evalove character
...
- **DO NOT skip the mobile screenshot.** Half the SMB owners using Evalove are on mobile. Missing mobile review is an incomplete review.
