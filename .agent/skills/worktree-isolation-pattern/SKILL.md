...
description: "The exact git worktree create, detect, and clean pattern for Evalove workers: detect-or-create from main-repo-root, child worktree commands, branch naming conventions (feat/fix/chore), atomic commits, and .worktrees/ gitignore enforcement."
tags: [git, evalove-specific, workflow, workers]
source: evalove-authored 2026-05-16
risk: low
---
...
# /Users/adamks/VibeCoding/Evalove                      abc1234 [main]
# /Users/adamks/VibeCoding/Evalove/.worktrees/ceo-1-xxx  def5678 [ceo-1-xxx]
...
pnpm -F @evalove/web exec tsc --noEmit apps/web/src/app/api/scan/route.ts

# Lint
pnpm -F @evalove/web lint --max-warnings 0
```
...
# Run relevant tests
pnpm -F @evalove/web test -- --testPathPattern="scan"
...
```json
{
  ...
  "worktree": "/Users/adamks/VibeCoding/Evalove/.worktrees/scan-rate-limit",
  "files_changed": [
